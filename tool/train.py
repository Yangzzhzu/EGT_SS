...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/cityscapes/cityscapes_EGT_SS101.yaml', help='config file')
    parser.add_argument('opts', help='see config/cityscapes/cityscapes_EGT_SS101.yaml for all options', default=None,
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.arch == "EGT_SS":
        from model.EGT_SS import EGT_SS
        model = EGT_SS(num_classes=args.classes, BatchNorm=BatchNorm, layers=args.layers,
